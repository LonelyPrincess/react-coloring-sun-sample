...
function SunSVG ({ color = '#EF9067' }) {
  ...
  return (
    <svg className="sun" x="0px" y="0px" viewBox="0 0 512.003 512.003">

      {/* --- Outer shape --- */}
      <path className="shine"
        d="M416.426,311.114l64.847-44.322c7.593-5.19,7.593-16.39,0-21.579l-64.847-44.322
      ...
      <g className="body">
        <circle style={{ fill: lightColor }} cx="260.321" cy="256.001" r="140.45"/>

        <path style={{ fill: darkColor }}
          d="M256.002,396.447c30.061,0,57.912-9.449,80.756-25.533
      ...
      {/* --- Smiling face --- */}
      <g className="cheeks">
        <ellipse cx="217.351" cy="226.43" rx="23.48" ry="18.698" />
	      <ellipse cx="344.621" cy="226.43" rx="23.48" ry="18.698" />
      </g>

      <g className="eyes">
        <path
          d="M231.04,215.281c-4.143,0-7.5-3.358-7.5-7.5v-8.291c0-4.142,3.357-7.5,7.5-7.5s7.5,3.358,7.5,7.5
		      v8.291C238.54,211.923,235.182,215.281,231.04,215.281z" />

        <path
          d="M330.941,215.281c-4.143,0-7.5-3.358-7.5-7.5v-8.291c0-4.142,3.357-7.5,7.5-7.5
		      c4.142,0,7.5,3.358,7.5,7.5v8.291C338.441,211.923,335.084,215.281,330.941,215.281z" />
      </g>

      <path className="mouth"
        d="M280.991,221.648c-7.216,0-14.076-3.124-18.824-8.572c-2.722-3.123-2.396-7.86,0.727-10.582
      ...
      <g className="light-beams">
        <path style={{ fill: darkColor }}
          d="M340.454,68.956c-2.149,0-4.334-0.414-6.443-1.287c-8.598-3.562-12.682-13.42-9.121-22.019
        ...
        <path style={{ fill: darkColor }}
          d="M495.139,371.914c-2.149,0-4.334-0.414-6.443-1.287l-35.242-14.598
        ...
        <path style={{ fill: darkColor }}
          d="M52.093,188.398c-2.149,0-4.334-0.414-6.443-1.287l-35.242-14.598
        ...
        <path style={{ fill: darkColor }}
          d="M156.939,512.001c-2.149,0-4.334-0.414-6.442-1.287c-8.598-3.562-12.682-13.42-9.121-22.019
        ...
        <path style={{ fill: darkColor }}
          d="M171.549,68.956c-6.614,0-12.887-3.917-15.576-10.408l-14.598-35.241
        ...
        <path style={{ fill: darkColor }}
          d="M16.864,371.914c-6.614,0-12.888-3.917-15.576-10.408c-3.561-8.599,0.522-18.457,9.121-22.019
        ...
        <path style={{ fill: darkColor }}
          d="M459.91,188.398c-6.614,0-12.888-3.917-15.576-10.408c-3.561-8.599,0.522-18.457,9.121-22.019
        ...
        <path style={{ fill: darkColor }}
          d="M355.064,512.001c-6.614,0-12.888-3.917-15.576-10.408l-14.598-35.241
